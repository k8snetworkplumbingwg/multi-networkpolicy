...
import (
	...
	v1 "github.com/k8snetworkplumbingwg/multi-networkpolicy/pkg/client/listers/k8s.cni.cncf.io/v1"
...
type MultiNetworkPolicyInformer interface {
	...
	Lister() v1.MultiNetworkPolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.K8sCniCncfIoV1().MultiNetworkPolicies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.K8sCniCncfIoV1().MultiNetworkPolicies(namespace).Watch(context.TODO(), options)
			},
		},
		&k8scnicncfiov1.MultiNetworkPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *multiNetworkPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&k8scnicncfiov1.MultiNetworkPolicy{}, f.defaultInformer)
}

func (f *multiNetworkPolicyInformer) Lister() v1.MultiNetworkPolicyLister {
	return v1.NewMultiNetworkPolicyLister(f.Informer().GetIndexer())
}
